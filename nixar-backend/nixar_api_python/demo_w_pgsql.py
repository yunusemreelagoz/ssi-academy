...
from test_utils import create_nixar_agent_w_pqsgl_wallet, create_schema_if_not_exist, create_credential_definition, \
...
if __name__ == '__main__':
  ...
  issuer = create_nixar_agent_w_pqsgl_wallet("python_issuer_w_pgsql", lambda: issuer_password, "ENDORSER")
  logging.info("Thw issuer agent was created")

  prover_password = test_utils.native_string("123456")
  prover = create_nixar_agent_w_pqsgl_wallet("python_prover_w_pgsql", lambda: prover_password, None)
  logging.info("The holder agent was created")

  verifier_password = test_utils.native_string("123456")
  verifier = create_nixar_agent_w_pqsgl_wallet("python_verifier_w_pgsql", lambda: verifier_password, None)
