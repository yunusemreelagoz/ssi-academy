...
/// * `base64_seed`: A seed for generation of the keypair (OPTIONAL)
/// # Returns
...
///     "base64_seed": "MDAwMDAwMDAwMDAwMDAwTXlMb3ZlbHlEaWQwMDAwMDEK"
///   }
/// }
/// ```
///
NativeString create_local_did(NixarAgentHandle agent_handle, NativeString base64_seed);
...
NativeString get_attribute(NixarAgentHandle agent_handle,
                           NativeString attr_name,
                           NativeString target_did);
...
/// * `base64_seed`: an optional base64_seed for to be used as a source for the pairwise did (Optional)
///
/// # Example
///
/// ```
...
/// * `client_nonce`: The nonce value taken from the credential request
///
/// ##Return
///  Ok.
///
...
/// ##Example
/// ```
/// const char *cred_id = "my_lovely_credential";
/// const char* result = prover_delete_credential(agent_handle, cred_id);
/// printf("%s\n", result);
/// ```
/// __Output__
/// ```
...
/// ```
///
NativeString prover_delete_credential(NixarAgentHandle agent_handle, NativeString cred_id);

/// # prover_get_credential
/// Get the cred with the given id from the wallet
/// ## Parameters
/// * `agent_handle`: The native handle created by `init_agent` call (MUST)
...
/// TODO: decorate with ApiResult
/// [
///   {"cred_id":"3ab3ff88-8350-405c-8cf9-93d48ab767fb"
///    "cred":{
///       "cred_def_id": "RUMNHC7qLbwSwLw5okvexA:3:CL:19:bilgem",
///       "rev_reg": {
///         "accum": "21 11C3C7C6535C24C9B8392362649DBC19C4CD4AE9537206D6F53651FFF45F5E0DB 21 11D16FF51D1059061925D0DD0D1FEDB34D48A31A4E96ADCB6C6CC1371B650CE61 6 8086AAEE1037CA6D2DD2F87991FCC7DDDC6A4E136389D555F61AC31B7EBB3086 4 435CB1FE47300E8F4597A7455282B6821D9A514FB6C8082109A58C35966D0065 6 8CD9CDCD80681E82AC06DC85AE2B92FFEF2727FC66FF099153B3B93215379C25 4 48F8F3858A6D14E8528C0F740BD17803C9D3C91588B838545D3F85F13AE3058C"
...
///  ...
/// ]
NativeString prover_get_credential_records(NixarAgentHandle agent_handle);
...
///
/// Create a presentation from the _Conditional Presentation Request_ received from a _verifier_
///
/// # Parameters
/// * `agent_handle`: The native handle created by `init_agent` call (MUST)
/// * `conditional_presentation_request`: Conditional Presentation Request (MUST)
/// * `self_attested_values`: Self Attested Values
/// # Return
/// Presentation as json
///
...
/// ```
///
NativeString prover_create_presentation_by_ast(NixarAgentHandle agent_handle,
                                               NativeString conditional_presentation_request,
                                               NativeString self_attested_values);
...
/// # verifier_verify_presentation_by_ast
///
/// Verify a __proof presentation__ received from the _prover_
///
/// ## Parameters
/// * `agent_handle`: The native handle created by `init_agent` call (MUST)
/// * `conditional_presentation_request`: Proof request that the verifier (this agent) created (MUST)
/// * `presentation`: Proof presentation that was created by the prover (MUST)
/// ## Return
///  Ok.
///
...
/// ```
///
NativeString verifier_verify_presentation_by_ast(NixarAgentHandle agent_handle,
                                                 NativeString conditional_presentation_request,
                                                 NativeString presentation);
...
/// Get the PUBLIC did (the initial did that is created during agent creation)
/// # Parameters
/// * `agent_handle`: The native handle created by `init_agent` call (MUST)
/// # Returns
/// The default did if exists, Nothing otherwise
NativeString get_public_did(NixarAgentHandle agent_handle);
